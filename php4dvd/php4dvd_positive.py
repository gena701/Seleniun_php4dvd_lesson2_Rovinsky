...
class Untitled(unittest.TestCase):
    ...
    def test_untitled(self):
        driver = self.driver
        driver.get(self.base_url + "/php4dvd/?go=movie&id=3")
        ...
        driver.find_element_by_name("imdbid").send_keys("1234")
        driver.find_element_by_name("name").clear()
        driver.find_element_by_name("name").send_keys("Test title 2")
        driver.find_element_by_name("aka").clear()
        driver.find_element_by_name("aka").send_keys("Test video 2")
